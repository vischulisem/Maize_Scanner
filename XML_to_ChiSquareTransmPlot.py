...
parser.add_argument('-w', '--width', metavar='', help='Width in pixels for the length of the window.', type=int)
parser.add_argument('-s', '--step_size', metavar='', help='Steps in pixels for window movement.', type=int)
